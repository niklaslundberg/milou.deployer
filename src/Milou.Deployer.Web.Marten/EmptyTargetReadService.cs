...
namespace Milou.Deployer.Web.Marten
{
    public class EmptyTargetReadService : IDeploymentTargetReadService
    {
        ...
        public Task<ImmutableArray<OrganizationInfo>> GetOrganizationsAsync(CancellationToken cancellationToken =
            default) => Task.FromResult(ImmutableArray<OrganizationInfo>.Empty);
