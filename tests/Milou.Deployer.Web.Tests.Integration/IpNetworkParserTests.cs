...
namespace Milou.Deployer.Web.Tests.Integration
{
    public class IpNetworkParserTests
    {
        ...
        {
            bool parsed = IpNetworkParser.TryParse("127.0.0.1/a", out var network);
        ...
        {
            bool parsed = IpNetworkParser.TryParse("127.0.0.1//32", out var network);
        ...
        {
            bool parsed = IpNetworkParser.TryParse("", out var network);
        ...
        {
            bool parsed = IpNetworkParser.TryParse("256.0.0.1/32", out var network);
        ...
        {
            bool parsed = IpNetworkParser.TryParse("127.0.0.1/33", out var network);
        ...
        {
            bool parsed = IpNetworkParser.TryParse("127.0.0.1", out var network);
        ...
        {
            bool parsed = IpNetworkParser.TryParse("127.0.0.1/-1", out var network);
        ...
        {
            bool parsed = IpNetworkParser.TryParse(null, out var network);
